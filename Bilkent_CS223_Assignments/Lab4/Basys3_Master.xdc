...
set_property PACKAGE_PIN W3 [get_ports {ledB0}]					
...
set_property PACKAGE_PIN P3 [get_ports {ledB2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ledB2}]
set_property PACKAGE_PIN N3 [get_ports {ledA0}]					
...
set_property PACKAGE_PIN L1 [get_ports {ledA2}]					
